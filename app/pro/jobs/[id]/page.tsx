...
export default function ProJobDetailPage({
  ...
  const alreadyConfirmed = job.proConfirmed;
  ...
  return (
    <main>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            Ügyfél azonosítója: {job.clientUserId.slice(0, 12)}…
          </div>
          {job.address && (
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              ...
              Te: {job.proConfirmed ? "Visszaigazolva" : "Vár"}
            </div>
            <div
            ...
            >
              ...
              Ügyfél: {job.clientConfirmed ? "Visszaigazolva" : "Vár"}
            </div>
          </div>
        </div>
      )}
      ...
      {/* Contact info */}
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 mb-6">
        <h2 className="font-bold mb-3">Ügyféladatok</h2>
        <p className="text-sm text-muted-foreground">
          Telefonszám az ajánlat elfogadása után érhető el a bejelentés
          részleteinél.
        </p>
      </div>
      ...
      {job.status === JobStatus.Completed && (
        <div className="flex items-center gap-2 text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-2xl p-5">
